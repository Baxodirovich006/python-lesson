...
#     return int(str(n)[::-1])
# print( reverse_digits(345), reverse_digits(456))
...
# print(first_letter("Zafar"))

# # 6
# last_letter = lambda word: word[-1]
# print(last_letter("Bexruz"))

# # 7
# first_last = lambda word: word[0] + word[-1]
# print(first_last("Zafar"))

# print(first_last("Bexruz"))
# # 8
...
# # 28
# my_list = [1, 4, 7, 6, 3, 2]
# new_juft = [x for x in my_list if x % 2 == 0]
# print(new_juft)
